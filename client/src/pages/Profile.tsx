      ...
      <div className="max-w-sm mx-auto">
        ...
        <div className="relative">
          ...
          <div className="px-6 pb-6">
            ...
            <div className="relative mb-4 h-20">
              ...
              <div className="absolute left-0 bottom-0 w-20 h-20 rounded-full border-4 border-dark-bg overflow-hidden bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-400/30">
                {userProfile.profileImageUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-xl" style={{ color: 'hsl(262, 83%, 58%)' }}>
            ...
            <div className="mb-4">
              <h2 className="text-2xl font-bold mb-1" style={{ color: 'hsl(262, 83%, 58%)' }}>
            ...
            <div className="flex items-center space-x-6 mb-6">
              <div className="text-center">
                <div className="text-xl font-bold" style={{ color: 'hsl(262, 83%, 58%)' }}>{userProfile.stats.posts}</div>
                <div className="text-xs" style={{ color: 'hsl(262, 83%, 58%)' }}>Posts</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-bold" style={{ color: 'hsl(262, 83%, 58%)' }}>{userProfile.stats.followers}</div>
                <div className="text-xs" style={{ color: 'hsl(262, 83%, 58%)' }}>Followers</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-bold" style={{ color: 'hsl(262, 83%, 58%)' }}>{userProfile.stats.following}</div>
              ...
              <TabsContent value="posts" className="mt-4">
                {postsLoading ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-semibold mb-2" style={{ color: 'hsl(262, 83%, 58%)' }}>No posts yet</h3>
