        ...
        <div className="relative">
          ...
          <div className="px-6 pb-6">
            ...
            <div className="mb-4">
              ...
              <p className="mb-2 text-gray-300">@{userProfile.username || "unknown"}</p>
              {userProfile.bio && (
            ...
            <div className="flex items-center space-x-6 mb-6">
              <div className="text-center">
                <div className="text-xl font-bold text-white">{userProfile.stats.posts}</div>
                <div className="text-xs text-gray-400">Posts</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-bold text-white">{userProfile.stats.followers}</div>
            ...
            <Tabs defaultValue="posts" className="w-full">
              ...
              <TabsContent value="remixes" className="mt-4">
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-white">No remixes yet</h3>
                  <p className="text-sm text-gray-400">Remixed content will appear here</p>
                </div>
              </TabsContent>
              ...
              <TabsContent value="liked" className="mt-4">
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-white">No liked posts yet</h3>
                  <p className="text-sm text-gray-400">Liked posts will appear here</p>
                </div>
              </TabsContent>
            </Tabs>
          </div>
